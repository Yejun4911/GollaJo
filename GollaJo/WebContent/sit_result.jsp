...
function reresult() {
	...
	if(arr.length!=0){
		...
		document.getElementById("reset1").setAttribute("onClick", "location.href='situationChoice.jsp?choice=2'");
	}
}
</script>
</head>
...
<form action="choice2.jsp">
	<div class = "content">
		<div class="choice">
			...
			<input type ="button" name="confirm" value="선택" id="realresult" onclick="location.href='sit_real_result.jsp'">
