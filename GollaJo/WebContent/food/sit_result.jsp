...
function reresult() {
	...
	if(arr.length!=0){
		...
		//document.getElementById("again").setAttribute("onClick", url());
	
	}else{
		document.getElementById("situation").innerHTML="메뉴가 더 이상 없습니다.";
		document.getElementById("again").value="처음으로";
		document.getElementById("again").setAttribute("onClick", "location.href='${pageContext.request.contextPath}/food/food_case.jsp?choice=2'");
	}
}
function url(){
...
<%@ include file="../view/header.jsp" %>
    ...
    <div class='masthead-image' id='master-container'>
        <div class='content center'>
            ...
            <div>
             <input type ="button" name="reset" value="재선택" id="again" class="again"onclick="reresult();">
			<input type ="button" name="confirm" value="선택" id="confirm" class="confirm" onclick="url();">
			</div>
        </div>
    </div>
</section>
